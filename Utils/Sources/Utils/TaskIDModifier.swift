...
public struct UniqueId<E: Hashable & Sendable>: Hashable {
    private let id: UUID
...
@propertyWrapper
public struct TaskID<Value: Hashable & Sendable>: DynamicProperty {
...
struct TaskIDModifier<E: Hashable & Sendable>: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content
            .task(id: uniqueEvent) { @Sendable in
